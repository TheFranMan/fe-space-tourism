    ...
    return (
        <section className="destinations details" aria-labelledby="destintion-title">
            ...
            <div className="destinations__tabs">
                <div className="destinations__tabs__list" role="tablist" aria-label="destinations" data-cy="tab-list">
                ...
                <div className="destinations__tabs__panel" role="tabpanel" id="europa-tab" aria-labelledby="europa" tabIndex="0" data-cy="tab-panel" hidden={ true } ref={ refs.europa.panel }>
                ...
                <div className="destinations__tabs__panel" role="tabpanel" id="titan-tab" aria-labelledby="titan" tabIndex="0" data-cy="tab-panel" hidden={ true } ref={ refs.titan.panel }>
